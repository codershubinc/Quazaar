...
## `/api/v0.1/spotify/track/currently-playing` [GET]
...
## `/api/v0.1/spotify/track/add-to-library` [GET/PUT]
...
## `/api/v0.1/spotify/track/check-in-library` [GET]
...
## `/api/v0.1/spotify/artist/follow` [GET/PUT]
