...
// endpoint /api/v0.1/player/info [GET]
...
// endpoint /api/v0.1/player/info/dbus [GET]
...
// endpoint /api/v0.1/player/info/windows [GET]
...
// endpoint /api/v0.1/player/list [GET]
...
// endpoint /api/v0.1/player/mpris/list [GET]
...
// endpoint /api/v0.1/player/windows/list [GET]
...
// endpoint /api/v0.1/player/play-pause [POST]
...
// endpoint /api/v0.1/player/play [POST]
...
// endpoint /api/v0.1/player/pause [POST]
...
// endpoint /api/v0.1/player/next [POST]
...
// endpoint /api/v0.1/player/previous [POST]
